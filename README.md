...
<head>
    ...
    <title>Portfolio - Debnil Pal</title>
    <style>
        body {
            font-family: Arial, sans-serif;
            margin: 0;
            padding: 0;
            background: linear-gradient(to bottom, #b1b9a8, #fad0c4);
            overflow-x: hidden;
            animation: gradientBackground 10s infinite alternate;
            font-size: 18px; /* Increased font size */
        }
        header {
            background: linear-gradient(90deg, #adb9bf, #c394ab);
            color: #fff;
            padding: 1.5rem 0;
            text-align: center;
        ...
        header h1 {
            margin: 0;
            color: #1b032d; /* White color for visibility */
            font-size: 3rem; /* Larger size for visibility */
        ...
        .section-title {
            ...
            margin-bottom: 2rem;
            color: #333;
            font-size: 2rem; /* Increased size for titles */
        ...
        .quote {
            ...
            margin: 2rem 0;
            color: #555;
            animation: quoteColorChange 3s ease-in-out infinite;
        }
        .images-container {
            display: flex;
            flex-wrap: wrap;
        ...
        @keyframes gradientBackground {
            0% { background: linear-gradient(to bottom, #ff9a9e, #fad0c4); }
...
<body>
    <header>
        ...
        <nav>
            ...
            <a href="javascript:void(0);" onclick="showSection('publish')">Publish</a>
